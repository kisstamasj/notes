...
- LoadBalancer: It provisions a load balancer for our application in supported cloud providers. It gives simple access to a POD wich runs in more than one instance.
